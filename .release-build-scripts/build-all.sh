...
if [ -z $release_targets_filter ]; then
	...
	no_std_filters='i586-pc-nto-qnx700\|powerpc-unknown-openbsd\|mipsel-sony-ps\|-none$\|none-softfloat\|none-elf\|none-eabi\|uefi\|cuda\|nintendo-switch\|atmega328\|mipsisa\|nuttx\|arm-none-eabi-gcc'
	...
	no_cargo_cross_and_uncommon_filters='aarch64-unknown-netbsd\|aarch64_be-unknown-netbsd\|arm64e-apple-darwin\|arm64ec-pc-windows-msvc\|riscv64gc-unknown-linux-musl\|x86_64-fortanix-unknown-sgx\|haiku\|powerpc64-ibm-aix\|powerpc64-unknown-netbsd\|powerpc64-unknown-freebsd\|powerpc64-unknown-openbsd\|powerpc64le-unknown-freebsd\|powerpc64-unknown-linux-musl\|powerpc64le-unknown-linux-musl\|riscv32gc-unknown-linux-gnu\|riscv32gc-unknown-linux-musl\|riscv32im-risc0-zkvm-elf\|riscv32imac-esp-espidf\|riscv32imafc-esp-espidf\|riscv32imc-esp-espidf\|riscv64-linux-android\|riscv64gc-unknown-freebsd\|riscv64gc-unknown-netbsd\|riscv64gc-unknown-openbsd\|s390x-unknown-linux-musl\|sparc-unknown-linux-gnu\|sparc64-unknown-netbsd\|sparc64-unknown-openbsd\|x86_64-uwp-windows-gnu\|x86_64h-apple-darwin\|xtensa-esp32-espidf\|xtensa-esp32s2-espidf\|x86_64-unknown-linux-gnux32\|thumbv7neon-unknown-linux-musleabihf\|armv7-unknown-netbsd-eabihf\|aarch64-unknown-openbsd\|mipsel-unknown-netbsd\|loongarch64-unknown-linux-musl\|armv6-unknown-netbsd-eabihf\|armv6-unknown-freebsd\|armv7-unknown-freebsd\|armv4t-unknown-linux-gnueabi\|armv5te-unknown-linux-gnueabi\|xtensa-esp32s3-espidf\|i686-uwp-windows-gnu'
	no_cargo_cross_to_be_fixed_filters='i686-unknown-netbsd\|i686-unknown-openbsd\|i686-apple-darwin\|aarch64-unknown-linux-musl'
...
for target in $(rustc --print target-list | grep -vi "$release_targets_filter"); do
	...
	if [ -f "./dist/iw4-servers-${target}" ] || [ -f "./dist/iw4-servers-${target}.exe" ]; then
