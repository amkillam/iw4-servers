...
if [ -z $release_targets_filter ]; then
	...
	extremely_obscure_os_filters='fuchsia\|solid_asp3\|qnx710\|aarch64-unknown-illumos\|teeos\|vxworks\|riscv64gc-unknown-hermit\|-ohos\|xous-elf'
	...
	broken_glibc_filters='armv5te-unknown-linux-uclibceabi'
	no_cargo_cross_and_uncommon_filters='aarch64-unknown-netbsd\|aarch64_be-unknown-netbsd\|arm64e-apple-darwin\|arm64ec-pc-windows-msvc\|riscv64gc-unknown-linux-musl\|x86_64-fortanix-unknown-sgx\|arm-vita-eabi-gcc\|haiku'
	release_targets_filter="$wasm_filters\|$no_std_filters\|$special_sdk_filters\|$extremely_obscure_os_filters\|$extremely_obscure_platform_filters\|$extremely_obscure_arch_filters\|$broken_std_filters\|$broken_cross_filters\|$no_cargo_cross_and_uncommon_filters\|$broken_glibc_filters"
fi
